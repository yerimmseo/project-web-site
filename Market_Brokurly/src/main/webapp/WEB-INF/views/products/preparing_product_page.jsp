...
<div class="header">
	...
	<div id="content">
	    <div id="main_box_one">
			<div class="thumb">
	            <img src='${path }/resources/img/product/상품준비중.jpg' alt="상품 대표 이미지" class="bg"
...
<!-- 	                        </div>  -->		
	                ...
	                <div class="group_btn off">
	                    ...
	                    <span class="btn_type1">
	                        <div class="basket" style="cursor: default; background-color: #c5c5c5;">장바구니 담기</div> 
	                    </span>
	                </div>
	            </div>
	        </div>
	    ...
	    <div id="main_box_two">
	        ...
	        <div class="photo_detail">
	            <img class="img img1" src='${path }/resources/img/product/상품준비중.jpg'>
